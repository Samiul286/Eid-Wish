...
import { ThemeId, DEFAULT_MESSAGE, themes, incrementViewCount, generateWishId, musicOptions, MusicId, DEFAULT_MUSIC } from '@/types/wish';
...
function StandardGreeting({ receiverName, senderName, message, theme, music }: GreetingPageProps) {
